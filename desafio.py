...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        ...
        print("\n@@@ Operação falhou! 0 valor do saque excede o limite. @@@")
...
def criar_usuario(usuarios):
    ...
    if usuario:
        ...
        return
    nome = input("Informe o CPF (somente número):")
    data_nascimento = input("Informe o Data de Nascimento (dd-mm-aaaa):")
    endereco = input("Informe o endereço (logradouro, nro - bairro - cidade/siglaEstado):")
